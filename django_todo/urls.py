...
# Allows importing of multiple views without taking much
# space by putting .views infront of each view name
...
urlpatterns = [
    ...
    # from links or forms in our templates. Through the URL and
